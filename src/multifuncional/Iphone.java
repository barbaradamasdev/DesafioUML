...
public class Iphone implements NavegadorDeInternet, AparelhoTelefonico, ReprodutorMusical {
    String donoDoAparelho = "Babi";
    String modelo = "17";
    public static void main(String[] args) throws Exception {
        Iphone iphone = new Iphone();
        System.out.println(">> Funcoes referentes ao serviço de telefonia:");
        iphone.ligar();
        iphone.iniciarCorreioVoz();
        iphone.atender();
        System.out.println(" ");
        System.out.println(">> Funcoes referentes ao serviço de navegador de internet:");
        iphone.adicionarNovaAba();
        iphone.exibirPagina();
        iphone.atualizarPagina();
        System.out.println(" ");
        System.out.println(">> Funcoes referentes ao serviço de reproducao de músicas:");
